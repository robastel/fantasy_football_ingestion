...
class SleeperSeason:
    def __init__(self, season_id, league_name, base_url=BASE_URL):
        ...
        :param season_id: The most recent league (a.k.a. season) ID
            (Sleeper uses a new league ID for each season). The league
            ID can be found at the end of the league's website URL. A
            "league" in Sleeper's nomenclature is actually a single
            season.
        :param league_name: The name of the league to which season_id
            belongs
